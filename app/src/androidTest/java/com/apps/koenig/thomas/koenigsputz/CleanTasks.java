...
public class CleanTasks
{
    ...
    public static CleanTask createWithDate(int id, DateTime time) {
        return new CleanTask("Name " + id, "Description " + id, "Responsible " + id, id, id + 1, time, Frequency.none, id, id,DateTime.now().plusSeconds(id), DateTime.now().plusSeconds(id), false, "Id" + id, "Id" + id);
    }
}
